...
public class KMKYSQLiteHelper extends SQLiteOpenHelper{
    ...
    /**
     * Constructor for KMKYSQLiteHelper
     *
     * @param context
     */
    public KMKYSQLiteHelper(Context context) {
    ...
    /**
     * onUpgrade for database. Not impemented as it is not needed.
     * @param database
     * @param oldVersion
     * @param newVersion
     */
    ...
    public void updateLog(long id, int incoming, int outgoing){
        ...
        try{
            ...
            if (incoming == 1){
                ...
                Log.d(Constants.TAG, "KMKYSQLiteHelper: updateLog: incoming log id " + id);
                ...
                Log.d(Constants.TAG, "KMKYSQLiteHelper: updateLog: outgoing log id " + id);
